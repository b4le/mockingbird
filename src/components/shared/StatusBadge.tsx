...
import type { ActionStatus, RiskStatus, ClaimStatus, ProjectStatus, EvidenceStrength } from "@/types";
...
const claimVariants: Record<ClaimStatus, string> = {
...
const strengthVariants: Record<EvidenceStrength, string> = {
...
const projectVariants: Record<ProjectStatus, string> = {
...
type StatusBadgeProps =
  ...
  | { type: "strength"; status: EvidenceStrength }
...
export function StatusBadge(props: StatusBadgeProps) {
  ...
  switch (props.type) {
    case "action":
      ...
      break;
    case "risk":
      className = riskVariants[props.status] ?? "";
      break;
    case "claim":
